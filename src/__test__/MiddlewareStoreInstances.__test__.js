...
describe('Middleware - store instance', () => {
  ...
  it('correct instance for 1 model, 2 stores, core method', function (done) {
    ...
    const store1 = new AppStore({middleware: [doubleNumbers]})
    const store2 = new AppStore({middleware: [doubleNumbers]})
  ...
  it('correct instance for: 1 model, 2 stores, 2 custom Interfaces, interface()->core() method', function (done) {
    ...
    const store1 = new AppStore({middleware: [doubleNumbers]})
    const store2 = new AppStore2({middleware: [doubleNumbers]})
